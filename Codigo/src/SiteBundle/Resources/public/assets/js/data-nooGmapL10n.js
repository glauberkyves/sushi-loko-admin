var nooGmapL10n = {
  ...
  "markers": [{
    ...
    "image": "<img src='/bundles/site/images/property/property1.jpg' class='attachment-property-infobox' alt='' />",
    ...
    "icon": "/bundles/site/images/icon/marker-icon.png"
  }, {
    ...
    "status": "rents",
    "category": "apartment",
    "icon": "/bundles/site/images/icon/marker-icon-apartment.png"
  }, {
    ...
    "status": "sales",
    "category": "condo",
    "icon": "/bundles/site/images/icon/marker-icon-condo.png"
  }, {
    ...
    "status": "open-house",
    "category": "coop",
    "icon": "/bundles/site/images/icon/marker-icon-coop.png"
  }],

...
namespace Super\ManterBundle\Service;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/manter-enquete/delete/' . $id . '" class="btn btn-primary">Remover</a>
      </div>
    </div>
  </div>
</div><button style="margin-right:5px;"data-toggle="modal" data-target="#myModal'.$id.'"  class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></button><a href="/manter-enquete/edit/' . $id . '" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>';
            }
        }
        return $itens;
    }
    ...
    public function postSave(AbstractEntity $entity = null)
    {
        ...
        if ($ActionUpdate) {
            ...
            for ($i = 1; $i <= $total; $i++) {
                ...
                $entidade   = $this->getService('service.resposta')->find($id);
            ...
            for ($i = 1; $i <= 3; $i++) {
                $entidade = $this->getService('service.resposta')->newEntity();
